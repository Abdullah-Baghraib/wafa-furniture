          ...
          <div className="bg-white p-6 rounded-lg shadow-md animate-on-scroll">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center gap-4 pt-4">
                ...
                <a href="#" className="h-12 w-12 bg-furniture-beige rounded-full flex items-center justify-center text-furniture-gray hover:bg-furniture-gold hover:text-white transition-colors">
                  <Share2 size={20} />
                </a>
              </div>
            </div>
